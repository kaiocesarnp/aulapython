...
# ---------------------
# Questão 02
# Considere o trecho a seguir, e responda como será o gráfico exibido.
...
# ----------------------
# Questão 04
# Ao executar o programa a seguir, o que será armazenado em resultado?
...
# Escolha uma opção:
# a. Um ndarray de 5x5, onde os elementos são 0, 6 ou 3.
# b. Um ndarray de 5x5, onde os elementos são  0, 1, 2, 4, ou 5.
# c. Um ndarray de 5x5, onde os elementos são 0 ou 3.                   RESPOSTA
# d. Um vetor de 25 posições, onde os elementos são  0, 1, 2, 4, ou 5.
# e. Um ndarray de 5x5, onde os elementos são  0,1,2,4,5 ou 6.
